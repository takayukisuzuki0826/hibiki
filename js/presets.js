...
export const PRESETS = [
  ...
  // ────────────────────────────────────────────
  {
    ...
    headphones: false,
    duration: 20,
    science: '528 Hzは「ラブ周波数」や「奇跡の音」として知られるソルフェジオ周波数のひとつで、愛や調和と結びつけられてきました。この周波数の純音が心身のリラクゼーションや内なる調和感をサポートする可能性があると言われています。心地よい響きとして、穏やかな気持ちの整えをサポートするために古くから活用されています。',
  },
  {
